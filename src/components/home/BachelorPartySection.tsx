...
const data = [
  {
    id: 1,
    img: "/assets/bachelor1.png",
    title: "Carnival Fun Birthday Decor",
    rating: 4.5,
  },
  {
    id: 2,
    img: "/assets/bachelor2.png",
    title: "Wild West Birthday Decor",
    rating: 4.8,
  },
  {
    id: 3,
    img: "/assets/bachelor3.png",
    title: "Rockstar Music Birthday Decor",
    rating: 4.0,
  },
  {
    id: 4,
    img: "/assets/bachelor4.png",
    title: "Mad Scientist Birthday Decor",
    rating: 4.0,
  },
];

export default function BachelorPartySection() {
  return (
    <section className="w-full px-4 py-16">
      <div className="mx-auto max-w-[1200px] rounded-[32px] bg-[#f3eef2] p-8 md:p-12 shadow-[0_25px_80px_rgba(0,0,0,0.25)]">

        {/* Heading */}
        <div className="text-center">
          <h2 className="text-4xl font-extrabold bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">
            Bachelor&apos;s Party Decoration
          </h2>
          ...
          {data.map((item) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                {/* Button */}
                <button className="mt-4 w-fit px-5 py-2 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 text-white text-sm font-semibold hover:scale-105 transition">
                  BOOK NOW →
                </button>
