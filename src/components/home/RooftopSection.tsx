          ...
          {data.map((item) => (
            <div key={item.id}>
              ...
              <div className="mt-2 flex items-center gap-2 text-sm">
                ...
                <span className="line-through text-gray-400">₹9999</span>
                <span className="bg-green-100 text-green-600 text-xs px-2 py-[2px] rounded-full">
                  24% OFF
                </span>
              </div>
